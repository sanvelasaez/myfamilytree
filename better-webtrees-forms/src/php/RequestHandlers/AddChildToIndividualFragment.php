...
/**
 * Espejo de core AddChildToIndividualPage con `layouts/ajax`. El `post_url`
 * apunta al *Action de core, así que el guardado no cambia. Ver EditFactFragment.
 */
final class AddChildToIndividualFragment implements RequestHandlerInterface
{
